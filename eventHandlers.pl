...
handleRightClick([OLD,MINESMAP,STATEMAP,P]) :- getTilePos(OLD,X,Y), gridToMap(X1,Y1,X,Y), getTile(X1,Y1,STATEMAP,State), State is 100, getTile(X1,Y1,MINESMAP,Val), Val is -1, setTile(STATEMAP,X1,Y1,101,NEWSTATEMAP), assertz(flagged(X1,Y1)), get(@minescount,value,A), atom_number(A,MC), MC1 is MC - 1, MC1=0, send(@minescount,string,MC1), !, swapIcon([OLD,'./icons/flag.xpm',MINESMAP,NEWSTATEMAP,P]), flag, stopCounter, uncoverMap(P, MINESMAP).
handleRightClick([OLD,MINESMAP,STATEMAP,P]) :- getTilePos(OLD,X,Y), gridToMap(X1,Y1,X,Y), getTile(X1,Y1,STATEMAP,State), State is 100, getTile(X1,Y1,MINESMAP,Val), Val is -1, setTile(STATEMAP,X1,Y1,101,NEWSTATEMAP), assertz(flagged(X1,Y1)), get(@minescount,value,A), atom_number(A,MC), MC1 is MC - 1, MC1>0, send(@minescount,string,MC1), !, swapIcon([OLD,'./icons/flag.xpm',MINESMAP,NEWSTATEMAP,P]), flag.
handleRightClick([OLD,MINESMAP,STATEMAP,P]) :- getTilePos(OLD,X,Y), gridToMap(X1,Y1,X,Y), getTile(X1,Y1,STATEMAP,State), State is 100, getTile(X1,Y1,MINESMAP,Val), Val \= -1, setTile(STATEMAP,X1,Y1,101,NEWSTATEMAP), assertz(flagged(X1,Y1)), !, swapIcon([OLD,'./icons/flag.xpm',MINESMAP,NEWSTATEMAP,P]), flag.
handleRightClick([OLD,MINESMAP,STATEMAP,P]) :- getTilePos(OLD,X,Y), gridToMap(X1,Y1,X,Y), getTile(X1,Y1,STATEMAP,State), State is 101, getTile(X1,Y1,MINESMAP,Val), Val is -1, setTile(STATEMAP,X1,Y1,100,NEWSTATEMAP), retract(flagged(X1,Y1)), get(@minescount,value,A), atom_number(A,MC), MC1 is MC + 1, send(@minescount,string,MC1), !, swapIcon([OLD,'./icons/unmarked.xpm',MINESMAP,NEWSTATEMAP,P]), unflag.
handleRightClick([OLD,MINESMAP,STATEMAP,P]) :- getTilePos(OLD,X,Y), gridToMap(X1,Y1,X,Y), getTile(X1,Y1,STATEMAP,State), State is 101, getTile(X1,Y1,MINESMAP,Val), Val \= -1, setTile(STATEMAP,X1,Y1,100,NEWSTATEMAP), retract(flagged(X1,Y1)), !, swapIcon([OLD,'./icons/unmarked.xpm',MINESMAP,NEWSTATEMAP,P]), unflag.